...
\lltxSection{Internship, coursework and personal reading history}
...
\begin{lltxJob}[Mathematics course instructed by Dr. Shane D' Mello]{MTH201 - Differential geometry of curves and surfaces}{Semester 3}{IISER Mohali}
...
\begin{lltxJob}[Mathematics course instructed by Dr. Shane D' Mello]{MTH436 - Knots and braids}{Semester 6}{IISER Mohali}
...
\begin{lltxJob}[Mathematics course instructed by Dr. Soma Maity]{Riemannian geometry}{Semester 7}{IISER Mohali}
...
% \begin{lltxJob}[Mathematics course instructed by Dr. Abhik Ganguli]{Arithmetic of elliptic curves}{Semester 8}{IISER Mohali}
% 	\item Elliptic curves over $\mathbb{C}$ and complex tori
% \end{lltxJob}
...
\lltxSubSection{Talks presented}
...
\begin{lltxItemize}
	...
	% \item \textbf{Curvature comparison theorems in Riemannian geometry}, Riemannian geometry course, IISER Mohali, Semester 7
